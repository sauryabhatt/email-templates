      ...
      <div className="right-align-container">
        <div className="landing-fifth-fold curated-fold">
          ...
          <div className="fold-content">
            ...
            >
              <div
                onClick={()=>router.push("/products/all-categories?f_product_types=Ready%20to%20ship&sort_by=visibleTo")}
                className="image-wrp"
              >
                {ship()}
              ...
              <div
                onClick={()=>router.push("/products/all-categories?f_product_types=Express%20custom&sort_by=visibleTo")}
                className="image-wrp"
              >
                {expres()}
              ...
              <div
                onClick={()=>router.push("/products/all-categories?f_product_types=Make%20to%20order&sort_by=visibleTo")}
                className="image-wrp"
              >
                {ordered()}
