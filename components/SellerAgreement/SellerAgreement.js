...
const SellerAgreement = (props) => {
  ...
  if (sellerType == "standard") {
    url =
      process.env.NEXT_PUBLIC_REACT_APP_SELLER_AGREEMENT_STANDARD_BASE_URL +
      process.env.NEXT_PUBLIC_REACT_APP_SELLER_AGREEMENT_STANDARD_FILENAME;
    filename =
      process.env.NEXT_PUBLIC_REACT_APP_SELLER_AGREEMENT_STANDARD_FILENAME;
  } else {
    url =
      process.env.NEXT_PUBLIC_REACT_APP_SELLER_AGREEMENT_ANCHOR_BASE_URL +
      process.env.NEXT_PUBLIC_REACT_APP_SELLER_AGREEMENT_ANCHOR_FILENAME;
    filename =
      process.env.NEXT_PUBLIC_REACT_APP_SELLER_AGREEMENT_ANCHOR_FILENAME;
  }
  ...
  if (verifiedUser == null) {
    if (props.userAuth != undefined && props.currentUserProfile != undefined) {
      ...
      if (
        seller_code_in_url ==
        props.userAuth.attributes.parentProfileId[0].split("::")[1]
      ) {
        fetch(
          process.env.NEXT_PUBLIC_REACT_APP_API_PROFILE_URL +
            "/profiles/my/verify-primary-logged-in-user?seller_code=" +
            seller_code_in_url,
          {
            method: "GET",
            headers: {
  ...
  return props.currentUserProfile == "SELLER" &&
    ...
    <div>
      ...
      <div
        id="banner-container-agreement-body"
        ...
        <div className="react-pdf__Page">
          <Col xs={24} md={24} lg={24} xl={24}>
            <Row>
              <Col xs={24} md={24} lg={24} xl={24}>
                <span
                  className={
                    mediaMatch.matches
                      ? "qa-font-san qa-fw-b qa-col-center qa-mar-top-3 agreement-header"
                      : "qa-font-san qa-fw-b qa-col-center qa-mar-top-3 agreement-header-mob"
                  }
                >
            ...
            {mediaMatch.matches ? (
              <Row
                className={
                  mediaMatch.matches ? "body-first-row" : "body-first-row-mob"
                }
              >
            ...
            {mediaMatch.matches ? (
              <Row className="body-second-row">
                <Col xs={22} md={22} lg={24} xl={24}>
                  <span
                    className="qa-font-san qa-fs-17 qa-mar-top-2"
            ...
            {mediaMatch.matches ? (
              <Row className="body-second-row">
                <Col xs={24} md={24} lg={24} xl={24}>
                  ...
                  >
                    ...
                    >
                      Mesindus Ventures-Terms of Sale for Sellers
                    </span>
                  </div>
                </Col>
              </Row>
              ...
              <Row
                style={
                  mediaMatch.matches
                    ? { paddingLeft: "60px", paddingTop: "20px" }
                    : {
                        paddingLeft: "25px",
                        paddingRight: "25px",
                        marginTop: "10px",
