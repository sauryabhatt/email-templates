      ...
      >
        ...
        >
          <Col xs={12} sm={12} md={12} lg={12}>
            <span
              className={
                mediaMatch.matches
                  ? "qa-font-san qa-fs-20"
                  : "qa-font-san qa-fs-17"
              }
              style={{ color: "#191919" }}
            >
              {props.data.fullName}
            ...
            props.data.isDefault ? (
              ...
              >
                <span
                  ...
                  onClick={(e) => props.makeDefault(props.data.id)}
                >
                  ...
                  <Col xs={12} sm={12} md={12} lg={12} className="qa-col-end">
                    <Tooltip placement="top" title={<span>Delete</span>}>
                      <span
                        className="qa-font-san qa-fs-14 qa-fw-b qa-cursor"
                        onClick={(e) =>
                          props.handleAddressDelete(props.data.id)
                        }
                      >
                        <DeleteOutlined />
                      </span>
        ...
        >
          <Col xs={24} sm={24} md={15} lg={15}>
            <span className="qa-font-san qa-fs-14" style={{ color: "#191919" }}>
            ...
            <Row>
              ...
              <Col xs={18} sm={18} md={3} lg={3}>
                <Tooltip placement="top" title={<span>Delete</span>}>
                  <span
                    className="qa-font-san qa-fs-14 qa-fw-b qa-cursor"
                    onClick={(e) => props.handleAddressDelete(props.data.id)}
                  >
                    <DeleteOutlined />
                  </span>
                </Tooltip>
        ...
        {mediaMatch.matches ? (
          ...
          >
            {props.data.isDefault ? (
              <Col xs={24} sm={24} md={0} lg={0} className="qa-col-center">
                <span
                  className="qa-font-san qa-fs-14 qa-fw-b"
                  style={{ color: "#D9BB7F" }}
                >
