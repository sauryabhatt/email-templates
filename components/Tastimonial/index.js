...
export default function Tastimonial() {
  ...
  const tastimonial_data = [
    ...
    },
    {
      url: "",
      text_message:
        "“I have just taken delivery of my cushions shipment. Extremely happy with the products. Thank you for all your help and prompt updates throughout this process. I will be placing more orders with Qalara soon.”",
      user_name: "- Boutique owner, United Kingdom",
    },
    {
      url: "",
      text_message:
        "“It was lovely chatting with you yesterday... the rugs look awesome!”",
      user_name: "- Business owner, New Zealand",
    },
    {
      url: "",
      text_message:
        "“I just wanted to extend my thanks for all the work you are putting in on our behalf, it is greatly appreciated”",
  ...
  return (
    <div className="tastimonial-wrapper">
      <span onClick={previous} className="cart-left-arrow cart-arrow">
        {left()}
      </span>
