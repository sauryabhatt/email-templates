    ...
    <div>
      <Layout className="seller-listing-container" id="product-listing-page">
        <Content style={{ background: "#f9f7f2" }}>
          {isMobile && (
            <div style={{ margin: "30px 30px 0px" }}>
              ...
              <span
                ...
                onClick={() => router.push("/recently-viewed/seller/")}
              >
                SELLERS{" "}
                <svg
                  width="18"
          ...
          <BreadCrumb pageId="product-listing" categoryName="Recently Viewed" />
        </Content>
          ...
          <Row className="qa-pad-0-30">
            <Col span={18}>
              ...
              <div className="qa-font-san qa-fs-14 seller-details-text qa-text-body">
                Browse recently viewed products in the last 30 days
              </div>
            </Col>
      ...
      <PLPFooter category="All Categories" />
    </div>
  );
}
