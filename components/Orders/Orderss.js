    ...
    <React.Fragment>
              ...
              >
                {mediaMatch && props.showOrderDetails ? (
                  <span
                    className="qa-cursor"
                    style={{ fontSize: "17px" }}
                    onClick={() => props.handleShowOrder(false)}
                  >
                    <Icon
                      component={backArrow}
                    ...
                    {props.showOrderDetails ? (
                      <span>
                        / {detailOrder.subOrders[detailOrder.subIndex].id}
                      </span>
                    ) : null}
                  </span>
                ) : (
                ...
                >
                  {current == "received" || current == "closed" ? (
                    <span
                      ...
                      style={{ color: "#191919" }}
                    >
                      *Quote is applicable till 30 days from the day the quote
                      was shared
                    </span>
                  ) : (
                    ""
      ...
      <React.Fragment>
        {props.showOrderDetails ? (
          ...
          props.typeOrder[current].length > 0 ? (
            <OrderDetail mediaMatche={props.mediaMatch} order={detailOrder} />
          ) : null
        ) : props.orders &&
          props.orders.length > 0 &&
          props.typeOrder[current].length > 0 ? (
          props.typeOrder[current].map((x) => (
            <OrderCard
            ...
            >
              ...
              <Col xs={17} sm={17} md={17} lg={17}>
                <span className="qa-font-san qa-fs-17 qa-tc-white">
                  ...
                  display. You can get started by sharing a Request for quote by
                  clicking below.
                </span>
              </Col>
