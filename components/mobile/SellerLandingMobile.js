...
import Icon, { StarOutlined, QuestionCircleOutlined } from "@ant-design/icons";
...
function SellerLandingMobile(props) {
  ...
  const requestLeadTimes = () => {
    ...
    //     .then((response) => {
    //       let orderTypes = [];
    //       if (response.length && response[0]["orderTypes"].length) {
    //         orderTypes = response[0]["orderTypes"];
    //       }

    //       let data = [];
    //       for (let [i, list] of orderTypes.entries()) {
    //         let obj = { ...list, key: i };
    //         data.push(obj);
    //       }
    //       setDataSourceOLT(data);
  ...
  const requestCategoryDetails = (type) => {
    ...
    //     .then((response) => {
    //       let data = [];
    //       for (let [i, list] of response.entries()) {
    //         let obj = { ...list, key: i };
    //         data.push(obj);
    //       }
    //       setDataSource(data);
  ...
  const showPdfModal = (type, value, name = "") => {
    setVisible(true);
    if (type === "pdf") {
      setPdfValue(value);
    ...
    if (imageUrl) {
      return (
        <div
          ...
          className="slider-slide qa-rel-pos"
          onClick={() => {
  ...
  return (
    ...
    >
      ...
      <div className="qa-mar-top-200 seller-container qa-mar-auto-30">
        <h3 className="qa-font-butler qa-fs-but-20 qa-mar-btm-0">
          Product range
        </h3>
        <Collapse
          bordered={false}
        ...
        >
          <Panel header="Product types" key="1">
            <div className="qa-fs-13">
              ...
              {/* {productPopupDetails.length > 5 && (
                <div
                  onClick={() => requestCategoryDetails("Product types")}
          ...
          <Panel header={altName} key="2">
            <div style={{ cursor: "pointer" }}>
              ...
              <div style={{ padding: "0px" }}>
                <div className="qa-fs-13 qa-lh">{seoTitle}</div>
                <div
                  className={`${
                    props.userProfile &&
                ...
                >
                  ...
                  >
                    ...
                    >
                      <div style={{ color: "#874439", marginTop: "10px" }}>
                        What's this?
                      </div>
                    </Tooltip>
                  </div> */}
                </div>
                <div className="qa-fs-13 qa-lh" style={{ marginTop: "5px" }}>
                  {props.userProfile &&
                  props.userProfile.verificationStatus == "ON_HOLD" ? (
                    <span
          ...
          <Panel header="Order minimum" key="3">
            <div className="qa-fs-13">
              <ul className="qa-mar-btm-0 qa-ul-p0">
                  ...
                  return (
                    <li key={i}>
                      {list.type === "READY TO SHIP"
                        ...
                        : "Custom orders"}{" "}
                      - {list.value}{" "}
                      {list.type === "Custom Orders" && smallBatchAvailable && (
                        <span
                          onClick={() =>
                ...
                <li>
                  Minimum Order Quantity (MOQ) is mentioned for each product
                  listed on Qalara.
                </li>
                <li>
        ...
        {!(profileType === "BUYER" && verificationStatus === "VERIFIED") ? (
          <Row className="qa-fs-14 qa-mar-top-2">
            <Col
              ...
              xl={12}
            >
              <div className="qa-tc-white qa-fs-14 qa-mar-btm-1 qa-fw-b">
                {leftTitle}
              </div>
      ...
      {valueCertifications.length > 0 && (
        <div className="certification-block qa-pad-btm-2">
          <div className="qa-mar-auto-30">
            <h3 className="qa-mar-btm-2 qa-pad-top-3 qa-font-butler qa-fs-but-20">
              Awards & Certifications
            </h3>
            <Certifications mobile={true} certificates={valueCertifications} />
          </div>
        </div>
      )}

      {aboutCompany && (
        <div className="seller-about-company">
          <div>
            <div
      ...
      <Modal
        ...
        centered
        bodyStyle={{ padding: "10px", background: "#f2f0eb" }}
        width="100%"
        style={{ top: 5 }}
        className="product-category-modal qa-font-san"
      >
        <div className="qa-pad-2 qa-rel-pos">
          <div
